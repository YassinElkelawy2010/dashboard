...
export function formExtrasFromParsed(x: CommandExtras): CommandFormExtrasState {
  return {
    ...
    autoReactionEmojis: x.autoReactions.emojis.length ? [...x.autoReactions.emojis] : [""],
    ...
    pinReply: x.pinReply,
    privateAckThenPost: x.privateAckThenPost,
    embedPingType: x.embedPingType,
    embedPingRoleId: x.embedPingRoleId,
    embedPingRoleIdsText: snowflakeListToText(x.embedPingRoleIds),
    quickLinkButtonEnabled: x.quickLinkButtonEnabled,
    quickLinkButtonLabel: x.quickLinkButtonLabel,
...
export function buildExtrasFromFormState(f: CommandFormExtrasState): CommandExtras {
  ...
  return {
    ...
    autoReactions: {
      enabled: f.autoReactionEnabled && emojis.length > 0,
      emojis,
    },
